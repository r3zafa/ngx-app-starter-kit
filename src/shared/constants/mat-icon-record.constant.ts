/**
 * Defines a record of Material Design icon names used throughout the application.
 * These icons are referenced by their string identifiers and can be used with Angular Material's mat-icon component.
 * 
 * @remarks
 * This constant provides a centralized collection of icon names to ensure consistency 
 * and ease of maintenance across the application's user interface.
 */

import { MatIconType } from '../types/mat-icon.type';

export const matIconRecord : Record<MatIconType, MatIconType> = {
  '10k': '10k',
  '10mp': '10mp',
  '11mp': '11mp',
  '123': '123',
