export const outdoorsMapStyle = {
    "bearing":
        0.0, "center":
        [8.542, 47.372], "glyphs":
        "https://tiles.stadiamaps.com/fonts/{fontstack}/{range}.pbf", "layers":
        [{"id": "background", "type": "background", "paint": {"background-color": "#f9f3ea"}}, {
            ...
            "source-layer": "park",
            "filter": ["==", "$type", "Polygon"],
            "paint": {"fill-color": "#d8e8c8", "fill-opacity": {"base": 1.8, "stops": [[6, 0.5], [12, 0.2]]}}
        }, {
            "id": "landuse-cemetery",
            "type": "fill",
            "source": "openmaptiles",
            ...
            "source": "openmaptiles",
            "source-layer": "park",
            "filter": ["in", "class", "public_park", "national_park", "nature_reserve"],
            "paint": {
                "fill-color": "#d5e8c2",
            ...
            "paint": {
                ...
                "line-width": {"base": 1, "stops": [[0, 0.6], [4, 1.4], [5, 2], [12, 4]]}
            }
        }, {
            ...
            "paint": {"fill-color": {"base": 1, "stops": [[15.5, "#f2eae2"], [16, "#dfdbd7"]]}, "fill-antialias": true}
        }, {
            "id": "building-top",
            "type": "fill",
            "source": "openmaptiles",
            ...
            "source": "openmaptiles",
            "source-layer": "transportation",
            "filter": ["all", ["==", "$type", "LineString"], ["all", ["==", "brunnel", "tunnel"], ["in", "class", "path", "footway"]]],
            "paint": {
                "line-color": "#cba",
            ...
            "layout": {"line-join": "round", "visibility": "visible"},
            "paint": {"line-color": "rgba(108, 159, 182, 1)", "line-width": 1.1, "line-dasharray": [2, 2]}
        }, {
            ...
            "layout": {"visibility": "visible"},
            "paint": {"fill-opacity": {"base": 1, "stops": [[13, 0], [14, 1]]}, "fill-color": "rgba(255, 255, 255, 1)"}
        }, {
            "id": "aeroway-taxiway",
            "type": "line",
            "source": "openmaptiles",
            ...
            "paint": {
                "line-color": "#e9ac77",
                "line-width": {"base": 1.2, "stops": [[5, 0.5], [8, 0.6], [9, 1.5], [20, 22]]}
            }
        }, {
            ...
            "source": "openmaptiles",
            "source-layer": "transportation",
            "filter": ["all", ["==", "$type", "LineString"], ["all", ["!in", "brunnel", "bridge", "tunnel"], ["in", "class", "path", "footway"]]],
            "paint": {
                "line-color": "#cba",
                "line-dasharray": {"stops": [[13, [1, 0.5]], [14, [2, 1]], [20, [3, 1]]]},
            ...
            "source": "openmaptiles",
            "source-layer": "piste",
            "filter": ["all", ["in", "class", "downhill", "nordic"], ["==", "$type", "LineString"]],
            "paint": {
            ...
            "filter": ["all", ["!in", "brunnel", "bridge", "tunnel"], ["in", "class", "secondary", "tertiary"]],
            "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
            "paint": {"line-color": "#e5d7a0", "line-width": {"base": 1.2, "stops": [[6.5, 0], [8, 0.5], [20, 13]]}}
        }, {
            "id": "highway-primary",
            "type": "line",
            "source": "openmaptiles",
            ...
            "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
            "paint": {"line-color": "#e5d7a0", "line-width": {"base": 1.2, "stops": [[5, 0.1], [9, 0.5], [20, 18]]}}
        }, {
            "id": "highway-trunk",
            "type": "line",
            "source": "openmaptiles",
            ...
            "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
            "paint": {"line-color": "#e5d7a0", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 18]]}}
        }, {
            "id": "highway-motorway",
            "type": "line",
            "source": "openmaptiles",
            ...
            "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
            "paint": {"line-color": "#e5b87e", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 10]]}}
        }, {
            "id": "railway-transit",
            "type": "line",
            "source": "openmaptiles",
            ...
            "source": "openmaptiles",
            "source-layer": "transportation",
            "filter": ["all", ["==", "$type", "LineString"], ["all", ["==", "brunnel", "bridge"], ["in", "class", "path", "footway"]]],
            ...
            "filter": ["all", ["==", "brunnel", "bridge"], ["in", "class", "secondary", "tertiary"]],
            "layout": {"line-join": "round"},
            "paint": {"line-color": "#e5d7a0", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 20]]}}
        }, {
            ...
            "filter": ["all", ["==", "brunnel", "bridge"], ["==", "class", "motorway"]],
            "layout": {"line-join": "round"},
            "paint": {"line-color": "#e5b87e", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 18]]}}
        }, {
            "id": "bridge-railway",
            "type": "line",
            "source": "openmaptiles",
            ...
            "paint": {"line-color": "hsl(0, 0%, 70%)", "line-width": {"base": 1, "stops": [[11, 1], [19, 2.5]]}}
        }, {
            "id": "cablecar-dash",
            "type": "line",
            "source": "openmaptiles",
            ...
            "source-layer": "waterway",
            "minzoom": 13,
            "filter": ["all", ["==", "$type", "LineString"], ["has", "name"], ["!=", "name", ""]],
            "layout": {
                "text-font": ["Stadia Italic"],
                "text-size": 14,
                "text-field": ["concat", ["get", "name:latin"], ["case", ["all", ["has", "name:nonlatin"], ["is-supported-script", ["get", "name:nonlatin"]]], ["concat", " ", ["get", "name:nonlatin"]], ""]],
                "text-max-width": 5,
            ...
            "layout": {
                ...
                "text-field": ["concat", ["get", "name:latin"], ["case", ["all", ["has", "name:nonlatin"], ["is-supported-script", ["get", "name:nonlatin"]]], ["concat", "\n", ["get", "name:nonlatin"]], ""]],
                "text-max-width": 5,
            ...
            "paint": {"text-halo-blur": 0.5, "text-color": "#666", "text-halo-width": 1, "text-halo-color": "#ffffff"}
        }, {
            "id": "poi-level-2",
            "type": "symbol",
            "source": "openmaptiles",
            ...
            "source-layer": "poi",
            "minzoom": 14,
            "filter": ["all", ["==", "$type", "Point"], ["<=", "rank", 14], ["has", "name"], ["!=", "name", ""]],
            "layout": {
                "text-padding": 2,
                "text-font": ["Stadia Semibold"],
                "text-anchor": "top",
            ...
            "source-layer": "poi",
            "minzoom": 13,
            "filter": ["all", ["==", "$type", "Point"], ["has", "name"], ["!=", "name", ""], ["==", "class", "railway"], ["==", "subclass", "station"]],
            "layout": {
                "text-padding": 2,
            ...
            "minzoom": 9,
            "filter": ["all", ["==", "$type", "Point"], ["<=", "rank", 2], ["has", "name"], ["!=", "name", ""]],
            "layout": {
                "text-padding": 2,
                "text-font": ["Stadia Regular"],
                "text-anchor": "top",
            ...
            "minzoom": 7,
            "maxzoom": 9,
            "filter": ["all", ["==", "$type", "Point"], [">=", "ele", 2500], ["has", "name"], ["!=", "name", ""], ["<=", "rank", 1]],
            "layout": {
                "icon-image": "mountain_11",
                "symbol-avoid-edges": true,
                "text-anchor": "top",
            ...
            "id": "park-reserve",
            "filter": ["all", ["match", ["get", "class"], ["nature_reserve", "protected_area"], true, false], ["==", ["geometry-type"], "Point"], ["==", ["get", "rank"], 1], ["!", ["any", ["in", "Open Access Land", ["get", "name"]], ["in", "State Game Land", ["get", "name"]]]]],
            "layout": {
                "text-field": ["concat", ["get", "name:latin"], ["case", ["all", ["has", "name:nonlatin"], ["is-supported-script", ["get", "name:nonlatin"]]], ["concat", "\n", ["get", "name:nonlatin"]], ""]],
                "text-font": ["Stadia Italic"],
                "text-line-height": 1.55,
                "text-max-width": 10,
                "text-size": {"base": 1.2, "stops": [[8, 12], [13, 14]]},
                "visibility": "visible",
                "symbol-placement": "point",
                "symbol-avoid-edges": true,
                "text-padding": 2,
            ...
            "id": "park-national",
            "filter": ["all", ["==", "class", "national_park"], ["==", "$type", "Point"], ["==", "rank", 1]],
            "layout": {
                "text-field": ["concat", ["get", "name:latin"], ["case", ["all", ["has", "name:nonlatin"], ["is-supported-script", ["get", "name:nonlatin"]]], ["concat", "\n", ["get", "name:nonlatin"]], ""]],
                "text-font": ["Stadia Italic"],
                "text-line-height": 1.55,
